...
> 👥 **Who it's for:** teams that use (or want to use) AI agent but need **multiple users, per-user isolation, and full control of their data** — without running one AI agent per person and without handing data to a cloud service.
