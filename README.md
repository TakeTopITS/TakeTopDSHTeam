...
- **💬 Instant chat** — 1:1 and group chat; send messages straight from the file manager or task manager into the chat box, and from a chat record straight into the AI conversation box!
