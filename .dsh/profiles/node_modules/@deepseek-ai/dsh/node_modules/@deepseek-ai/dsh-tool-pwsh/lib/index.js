...
function apply(ctx, config = {}) {
	...
	// PATCH: disable sandbox escalation — non-admin must not request a wider
	// access mode (avoids approval dialogs and workspace bypass).
	...
	*/
	...
	ctx.tools.register(defineTool({
		...
		async execute(args, exec) {
			...
			// Reject commands that reference absolute paths outside the session
			// workspace (other drives / rooted paths), so a non-admin agent cannot
			// browse the host filesystem beyond its workspace.
